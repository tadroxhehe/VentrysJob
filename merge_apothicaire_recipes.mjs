...
job.recipes = [
  ...
  R("apo_remede_maux", "Remede maux de tete", "", [ing("ventrysitem:res_feuille_de_lune", 2), ing("ventrysitem:res_menthe_des_collines", 2), ing("minecraft:glass_bottle", 1)], out("ventrysitem:item_remede_contre_les_maux_de_tete", 1)),
  R("apo_remede_anti_douleur", "Remede anti-douleur", "", [ing("ventrysitem:res_racine_dorage", 1), ing("ventrysitem:res_feuille_de_lune", 2), ing("minecraft:glass_bottle", 1)], out("ventrysitem:item_remede_anti_douleur", 1)),
  ...
  R("apo_tisane_calmante", "Tisane calmante", "", [ing("ventrysitem:res_menthe_des_collines", 2), ing("ventrysitem:res_fleur_de_lys", 1), ing("minecraft:glass_bottle", 1)], out("ventrysitem:item_tisane_calmante", 1)),
  ...
  R("apo_remede_dhiver", "Remede d'hiver", "", [ing("ventrysitem:res_menthe_des_collines", 1), ing("ventrysitem:res_ronce_pourpre", 1), ing("ventrysitem:res_feuille_de_lune", 1), ing("minecraft:glass_bottle", 1)], out("ventrysitem:item_remede_dhiver", 1)),
  R("apo_infusion_fortifiante", "Infusion fortifiante", "", [ing("ventrysitem:res_racine_dorage", 1), ing("ventrysitem:res_plantin", 1), ing("ventrysitem:res_feuille_de_lune", 1), ing("minecraft:glass_bottle", 1)], out("ventrysitem:item_infusion_fortifiante", 1)),
  R("apo_infusion_adrenaline", "Infusion d'adrenaline", "", [ing("ventrysitem:res_racine_dorage", 2), ing("ventrysitem:res_verveine_noir", 1), ing("minecraft:glass_bottle", 1)], out("ventrysitem:item_infusion_dadrenaline", 1)),
  R("apo_infusion_reconstituante", "Infusion reconstituante", "", [ing("ventrysitem:res_plantin", 2), ing("ventrysitem:res_racine_dorage", 1), ing("minecraft:glass_bottle", 1)], out("ventrysitem:item_infusion_reconstituante", 1)),
  R("apo_the_de_lune", "The de lune", "", [ing("ventrysitem:res_ronce_pourpre", 1), ing("ventrysitem:res_feuille_de_lune", 2), ing("minecraft:glass_bottle", 1)], out("ventrysitem:item_the_de_lune", 1)),
  R("apo_infusion_somnifere", "Infusion somnifere", "", [ing("ventrysitem:res_verveine_noir", 1), ing("ventrysitem:res_menthe_des_collines", 1), ing("minecraft:glass_bottle", 1)], out("ventrysitem:item_infusion_somnifere", 1)),
  R("apo_infusion_lierre_mortel", "Infusion lierre mortel", "", [ing("ventrysitem:res_lierre_mortel", 2), ing("ventrysitem:res_verveine_noir", 1), ing("minecraft:glass_bottle", 1)], out("ventrysitem:item_infusion_lierre_mortel", 1)),
  R("apo_remede_anti_lierre", "Remede anti-lierre mortel", "", [ing("ventrysitem:res_lierre_mortel", 1), ing("ventrysitem:res_iris_cendre", 1), ing("ventrysitem:res_feuille_de_lune", 1), ing("minecraft:glass_bottle", 1)], out("ventrysitem:item_remede_anti_lierre_mortel", 1)),
